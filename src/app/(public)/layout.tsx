...
export default function PublicLayout({ children }: PublicLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 flex flex-col">
      ...
      {/*  Navbar  */}
      <header className="sticky top-0 z-20 h-16 flex items-center justify-between px-4 sm:px-6 border-b border-neutral-200 dark:border-neutral-800 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm">
